#!/bin/bash
/media/4TB1/blasto/mito/triat_mito_contig.fa
/media/4TB1/blasto/mito/p57_mito_contig.fasta

bw2_dir='/home/nenarokova/tools/bowtie2-2.2.9/'
base_name='/media/4TB1/blasto/mito/triat_mito_contig'
ref='/media/4TB1/blasto/mito/triat_mito_contig.fa'
