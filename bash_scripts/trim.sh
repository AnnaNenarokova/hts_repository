...
file_fw='/media/4TB1/kinetoplastids_hinxton/species/cer3/illumina/raw_reads19109_8#2_1.fastq'
file_rv='/media/4TB1/kinetoplastids_hinxton/species/cer3/illumina/raw_reads/19109_8#2_2.fastq'

$trim PE -phred33 $file_fw $file_rv $p_out_fw $u_out_fw $p_out_rv $u_out_rv $illumina_clip LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 MINLEN:50
