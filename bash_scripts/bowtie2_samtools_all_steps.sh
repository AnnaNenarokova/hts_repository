...
r1="/media/4TB1/novymonas/transcriptome/trimmed_reads/azi_rna_trimmed_1.fq.gz"
r2="/media/4TB1/novymonas/transcriptome/trimmed_reads/azi_rna_trimmed_2.fq.gz"

alignment=$base_name".sam"
report=$base_name".txt"

/home/nenarokova/tools/bowtie2-2.2.9/bowtie2 --very-sensitive -p 30 -x $bw2_base -1 $p1_1 -2 $p1_2 -S $alignment 2> $report
