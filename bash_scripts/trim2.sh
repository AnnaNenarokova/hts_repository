...
p_out_fw=$trim_dir$name'_paired_out_fw3.fastq'
u_out_fw=$trim_dir$name'_unpaired_out_fw3.fastq'
p_out_rv=$trim_dir$name'_paired_out_rv3.fastq'
u_out_rv=$trim_dir$name'_unpaired_out_rv3.fastq'
