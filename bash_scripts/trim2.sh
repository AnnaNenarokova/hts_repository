...
p_out_fw=$trim_dir$name'_paired_out_fw2.fastq'
u_out_fw=$trim_dir$name'_unpaired_out_fw2.fastq'
p_out_rv=$trim_dir$name'_paired_out_rv2.fastq'
u_out_rv=$trim_dir$name'_unpaired_out_rv2.fastq'
...
threads=32
$trim PE -threads $threads $file_fw $file_rv $p_out_fw $u_out_fw $p_out_rv $u_out_rv $illuminaclip LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 MINLEN:30
