...
/home/nenarokova/tools/bbmap/bbduk.sh overwrite=true in1=$in1 in2=$in2 out1=$out1 out2=$out2 ref=$adapters ktrim=r k=22 mink=11 hdist=2 tpe tbo t=64 qtrim=rl trimq=20 > $err_out
