...
out=$out_folder'bw2_stats/E262_pyrrhocoris.txt'
clean_reads_paired=$out_folder'cleaned_reads/E262_ad_q20_l50_paired_cleaned.fastq'
clean_reads_unpaired=$out_folder'cleaned_reads/E262_ad_q20_l50_unpaired_cleaned.fastq'
paired_fw=$read_folder'E262_paired_out_fw_ad_q20_l50.fastq'
paired_rv=$read_folder'E262_paired_out_rv_ad_q20_l50.fastq'
unpaired_fw=$read_folder'E262_unpaired_out_fw_ad_q20_l50.fastq'
unpaired_rv=$read_folder'E262_unpaired_out_rv_ad_q20_l50.fastq'
