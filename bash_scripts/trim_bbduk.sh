...
/home/nenarokova/tools/bbmap/bbduk.sh overwrite=true in1=$fw in2=$rv out1=$trimmed_fw out2=$trimmed_rv minlen=50 qtrim=rl trimq=20 ktrim=r k=25 mink=11 ref=adapters.fa hdist=1
