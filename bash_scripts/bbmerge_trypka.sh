...
rv=$dir_raw'wt_S2_L001_R1_001.fastq.gz'

dir_merged="/media/4TB1/novymonas/merged_reads/"
merged=$dir_merged'wt_S2_L001_R1_001.fastq.gz'
unmerged_fw=$dir_merged'wt_S2_L001_R1_001.fastq.gz'
unmerged_rv=$dir_merged'wt_S2_L001_R1_001.fastq.gz'
report=$dir_merged'wt_S2_L001_R1_001.fastq.gz'
