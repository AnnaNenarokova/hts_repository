...
python BUSCO.py --cpu 16 --species leishmania_tarentolae --long -i /home/kika/blastocrithidia/transcriptome/p57_translated_RNA_Trinity.fasta -o BUSCO_p57_translRNA_euk_set -l /home/tomas/GIT/busco/eukaryota_odb9 -m tran -f
