...
python BUSCO.py --cpu 16 --species leishmania_tarentolae --long -i /home/kika/blastocrithidia/genome/p57_DNA_scaffolds.fa -o BUSCO_p57_DNA -l /home/tomas/GIT/busco/protists_ensembl -m genome
