...
python BUSCO.py --cpu 16 --species leishmania_tarentolae --long -i /home/kika/blastocrithidia/genome/p57_DNA_translated.fa -o BUSCO_p57_DNA_euk_set -l /home/tomas/GIT/busco/eukaryota_odb9 -m prot -f
