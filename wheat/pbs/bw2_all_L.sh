...
cd $folder
cd trim_out
bowtie2 --local --very-fast-local --reorder -a -x $bt2_base, -1 paired_out_fw.fastq -2 paired_out_rv.fastq -U unpaired_out_fw.fastq,unpaired_out_rv.fastq -S ../wheat_alignment.sam