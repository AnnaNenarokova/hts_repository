...
group_tag = "euk"
tree_path = "/Users/vl18625/work/euk/markers_euks/nina_markers/singlehit_results/msa1_LGG/treefiles/COG0820.faa_lgg.treefile"
tree = Tree(tree_path)
leaf_tags = get_tags_leaves_eukprot(tree)


test_node = get_largest_group_node(tree, leaf_tags, group_tag)
