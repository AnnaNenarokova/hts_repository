...
def get_result_table(db_path, outpath):
    ...
    fieldnames = ['seqid', 'og', 'mitochondrial', 'loc', 'locrate', 'function', 'subj_id', 'subj_og', 'subj_function', 'evalue', 'alen_slen', 'rev_evalue', 'rev_alen_qlen', 'best_hit']
    default_seq_dict = {}
        ...
        if seq.organism == 'Euglena gracilis':
            ...
            if bs:
                ...
                if reverse_hit:
                    ...
                    seq_dict['best_hit'] = reverse_hit[1]
...
outpath = '/home/anna/Dropbox/phd/db/result.csv'
