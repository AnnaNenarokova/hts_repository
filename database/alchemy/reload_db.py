...
def reload_db(db_path, fasta_paths, blast_csv_paths=False, blast_outfmt=False, reload_seq=True, reload_bh=True, load_description=True, update_targetp=True, check_functions=True):
...
db_path = 'sqlite:////home/anna/Dropbox/phd/db/hemistasia_mito.db'
...
data_paths = {
    ...
    'Hemistasia phaeocysticola': {'fasta_path':'/home/anna/Dropbox/phd/db/Hemistasia_cutadapt_trinity_run3.fasta', 'seqtype': 'nucl'}
                }
...
# blast_csv_paths = [
# '/home/anna/Dropbox/phd/db/proteomes/reference_proteomes/bl_reports/euglena_all_proteins_bl_report.csv',
# '/home/anna/Dropbox/phd/db/proteomes/euglena/data/E_gracilis_transcriptome_final.PROTEINS/blast_reports/reference_proteomes_bl_report.csv'
# ]

blast_csv_paths = [
'/home/anna/Dropbox/phd/db/ref_hemistasia_db_bl_report.csv',
'/home/anna/Dropbox/phd/db/hemistasia_ref_db_bl_report.csv'
]

blast_outfmt = 'qseqid qlen sseqid slen length evalue pident bitscore mismatch gaps qstart qend sstart send'


reload_db(db_path, data_paths, blast_csv_paths, blast_outfmt, reload_seq=False, reload_bh=True, update_targetp=False)