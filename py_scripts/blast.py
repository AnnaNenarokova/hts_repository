...
blast_cline = NcbiblastxCommandline(cmd='tblastn', 
									...
									out='/home/kika/blasto_project/blastocrithidia/datasets/all_SSU_NCBI_141_and_Hinxton_jac_RNA/jacRNA_blast.xml',
									evalue=10,
									outfmt=5,
									word_size=3)
...
result_handle = open('/home/kika/blasto_project/blastocrithidia/datasets/all_SSU_NCBI_141_and_Hinxton_jac_RNA/jacRNA_blast.xml')
blast_records = NCBIXML.parse(result_handle)
output = open('/home/kika/blasto_project/blastocrithidia/datasets/all_SSU_NCBI_141_and_Hinxton_jac_RNA/jacRNA_blast.xlsx', 'w')
