...
query_path = "/media/4TB3/trypanoplasma/pacbio_consensus_quiver3_most_covered_scaffolds.fasta"
custom_outfmt = 'qseqid qlen sseqid slen length evalue pident bitscore mismatch gaps qstart qend sstart send'
subj_pathes = [
"/home/pasha/CLC_Databases/nr"
]

for subj_path in subj_pathes:
    new_blast = Blast(query_path=query_path, db_path=subj_path, db_type='nucl', threads=32)
