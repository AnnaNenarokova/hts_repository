...
query_path = '/home/nenarokova/genomes/novymonas/assembly/wt_all_spades/scaffolds.fasta'
custom_outfmt = 'qseqid qlen sseqid slen length evalue pident bitscore mismatch gaps qstart qend sstart send'
subj_pathes = [
"/home/nenarokova/genomes/reference_kinetoplastids/ref_for_novymonas.fa"
]

for subj_path in subj_pathes:
    new_blast = Blast(query_path=query_path, subj_path=subj_path, db_type='nucl', threads=64)
