...
bl_report = new_blast.blast(bl_type='blastp', evalue=0.1, outfmt='comma_values', custom_outfmt=custom_outfmt, word_size=3)
...
# bl_report = '/home/anna/bioinformatics/euglenozoa/euglena/sequences/E_gracilis_transcriptome_final.PROTEINS/blast_reports/editing proteins_bl_report.csv'
