...
def add_diamond_result(diamond_path, seq_dict, ncbi=False, outfmt_opts=False, delimeter="\t"):
    if not outfmt_opts:
...
ref_fasta_path = "/Users/annanenarokova/work/myxo_local/Sphaerospora_molnari_G.faa"
diamond_ref_path = "/Users/annanenarokova/work/myxo_local/hgt/smol_smol_dmnd.tsv"

diamond_ncbi_path = "/Users/annanenarokova/work/myxo_local/hgt/smol_diamond_nr_normal.tsv"

outfolder = "/Users/annanenarokova/work/myxo_local/hgt/fasta/"

seq_dict = {}

print ("Reading refset diamond")
seq_dict, ref_set = add_diamond_result(diamond_ref_path, seq_dict, ncbi=False)
print (f"Refset diamond dataset length is {len(ref_set)}")

print ("Reading ncbi diamond results")
seq_dict, ncbi_set = add_diamond_result(diamond_ncbi_path, seq_dict, ncbi=True)
